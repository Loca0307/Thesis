...
def collect_random_commits(headers, output_jsonl_path, min_lines, max_lines, valid_extensions, max_commits=20):
    """Colleziona commit casuali pre-2020 con metadati strutturati."""
    ...
    print(f"🎯 Raccolta completata: {collected} commit salvati in {output_jsonl_path}")
